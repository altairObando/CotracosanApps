...
public class ActivityConsolidadoCreditoBus extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(ActivityConsolidadoCreditoBus.this);
    ...
    public class getCredito extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            String uri = "http://cotracosan.somee.com/ApiCreditos/GetCreditos?idBus=" + idBus;
            ...
            VolleySingleton.getInstance(ActivityConsolidadoCreditoBus.this).addToRequestQueue(request);
            return null;
        }
    }
